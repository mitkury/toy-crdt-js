...
import { PNCounter } from "/js/g-counter/pncounter.js"
    ...
    constructor(parentElement) {
        this.#containerEl = div(parentElement, wrapperEl => {
            ...
            div(wrapperEl, buttonEl => {
                ...
                buttonEl.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
